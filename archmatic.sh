#!/usr/bin/env bash
# Created by Adurthi Krishna Saathwik 
# A compilation of all the files from ArchMatic's repository
# Made for the Users Of the World
#-------------------------------------------------------------------------
#      _              _  _ _ _    _ _ _ _ _
#     /_\  |\    /|  /_\     /   |
#    / _ \ | \  / | / _ \   /    |_ _ _ _ _
#   /_/ \_\|  \/  |/_/ \_\ /_ _ _|
#                                |_ _ _ _ _
#  AMAZE OS Post Install Setup and Config
#-------------------------------------------------------------------------
...
postInstallation
clear
echo -n "\n\n\nAmaze finished the installation and configuration of the system!\n\n\n"
